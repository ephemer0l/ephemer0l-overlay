...
#SRC_URI="
#	amd64? ( ${URI}/${_FULL_VERSION}/${_APPNAME}_${_FULL_VERSION}_amd64.deb )
#	x86? ( ${URI}/${_FULL_VERSION}/${_APPNAME}_${_FULL_VERSION}_i386.deb )"

# Works for plex alf 1.15.0.573-123756e9a 
URI="https://artifacts.plex.tv/plex-media-server-alpha"
SRC_URI="
	amd64? ( ${URI}/${_FULL_VERSION}/debian/${_APPNAME}_${_FULL_VERSION}_amd64.deb )
	x86? ( ${URI}/${_FULL_VERSION}/debian/${_APPNAME}_${_FULL_VERSION}_i386.deb )"
