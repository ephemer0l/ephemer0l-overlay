...
SRC_URI="https://files.plexapp.com/elan/ffmpeg/plex-ffmpeg-2019-08-23.tgz"
...
#	)
	...
	set -- "${S}/configure" \
		--prefix="${EPREFIX}/usr/lib/plexmediaserver/" \
		--bindir="${EPREFIX}/usr/lib/plexmediaserver/" \
		--libdir="${EPREFIX}/usr/lib/plexmediaserver/lib/" \
		--shlibdir="${EPREFIX}/usr/lib/plexmediaserver/lib/" \
		--docdir="${EPREFIX}/usr/lib/plexmediaserver/" \
		--mandir="${EPREFIX}/usr/lib/plexmediaserver/" \
		--enable-shared \
		--cc="$(tc-getCC)" \
		--cxx="$(tc-getCXX)" \
		--ar="$(tc-getAR)" \
...
# From https://github.com/comio/plex-gentoo/blob/master/media-video/plex-ffmpeg/plex-ffmpeg-2016.12.ebuild	
...
#	[ -f "RELEASE_NOTES" ] && dodoc "RELEASE_NOTES"
	dosym "${EPREFIX}/usr/$(get_libdir)/plexmediaserver/ffmpeg" "${EPREFIX}/usr/$(get_libdir)/plexmediaserver/Plex\ Transcoder"
}
